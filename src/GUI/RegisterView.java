...
//    }
    ...
    public void displayGUI() {
        ...
        title.setFont(new Font("Open Sans", Font.PLAIN, 25));
        ...
        gender.setFont(new Font("Open Sans", Font.PLAIN, 20));
        gender.setSize(100, 20);
        gender.setLocation(100, 200);
        c.add(gender);

        male = new JRadioButton("Male");
        male.setFont(new Font("Open Sans", Font.PLAIN, 15));
        ...
        female.setFont(new Font("Open Sans", Font.PLAIN, 15));
        ...
        dob = new JLabel("DOB");
        dob.setFont(new Font("Open Sans", Font.PLAIN, 20));
        dob.setSize(100, 20);
        dob.setLocation(100, 250);
        c.add(dob);

        date = new JComboBox(dates);
        date.setFont(new Font("Open Sans", Font.PLAIN, 15));
        date.setSize(50, 20);
        date.setLocation(200, 250);
        c.add(date);

        month = new JComboBox(months);
        month.setFont(new Font("Open Sans", Font.PLAIN, 15));
        month.setSize(60, 20);
        month.setLocation(250, 250);
        c.add(month);

        year = new JComboBox(years);
        year.setFont(new Font("Open Sans", Font.PLAIN, 15));
        year.setSize(60, 20);
        ...
        temail.setFont(new Font("Open Sans", Font.PLAIN, 15));
        temail.setSize(200, 75);
        ...
        sub.setFont(new Font("Open Sans", Font.PLAIN, 15));
        sub.setSize(100, 20);
        ...
        reset.setFont(new Font("Open Sans", Font.PLAIN, 15));
        ...
        tout = new JTextArea();
        tout.setFont(new Font("Open Sans", Font.PLAIN, 15));
        ...
        res = new JLabel("");
        res.setFont(new Font("Open Sans", Font.PLAIN, 20));
        res.setSize(500, 25);
        res.setLocation(100, 500);
        c.add(res);

        resadd = new JTextArea();
        resadd.setFont(new Font("Open Sans", Font.PLAIN, 15));
